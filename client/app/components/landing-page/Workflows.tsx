...
import { MousePointer2, Search, Wand } from 'lucide-react';

const steps = [
  {
    id: 1,
    title: "Select a request",
    desc: "Browse incoming founder requests and click on the one you want to match. Review their pitch, blurb, and needs at a glance.",
    icon: <MousePointer2 className="w-7 h-7 text-white" />,
  },
  {
    id: 2,
  ...
  <section className="relative w-full bg-[#010204] py-32 overflow-hidden flex flex-col items-center">
    ...
    <div className="absolute inset-0 pointer-events-none z-0">
      ...
      <div 
        ...
        style={{
          background: 'rgba(132, 86, 201, 0.09)',
          filter: 'blur(100px)',
    ...
    <div className="relative max-w-7xl mx-auto px-8 z-10 w-full text-center">
      ...
      <div className="mb-24">
        ...
        <h2 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tighter">
          <span className="text-transparent bg-clip-text bg-linear-to-r from-[#21e6c1] via-[#21A3FF] to-[#8456c9] animate-shimmer bg-size-[200%_auto]">
            Warmly
          </span>
      ...
      <div className="relative w-full">
        {/* Connective line */}
        <div className="hidden md:block absolute left-[15%] right-[15%] top-7 h-px bg-blue-500/20 z-0" />
