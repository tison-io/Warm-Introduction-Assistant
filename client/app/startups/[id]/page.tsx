...
export default function SingleStartupPage() {
    ...
    const handleTransform = async (investor: Investor) => {
        ...
        const preferredIntroFormat = investor.preferred_intro_format; 
        const introPreferencesText = investor.intro_preferences_text; 
        ...
        const investorPreference = preferredIntroFormat as IntroFormat;
